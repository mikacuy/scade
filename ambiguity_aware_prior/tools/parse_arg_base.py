...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='/orion/downloads/coordinate_mvs/', required=True, help='Path to images')
        ...
        parser.add_argument('--run_name', type=str, default='./log', help='run name')
